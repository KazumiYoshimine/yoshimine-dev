          ...
          <b-collapse id="nav-collapse2" is-nav>
            ...
            <b-navbar-nav class="ml-auto">
              <div v-if="isLogin" class="m-0 p-0 d-flex align-items-center">
                ...
                <b-button :variant="commonData.selectedMenuBtnColor" :size="commonData.selectedBtnSize" class="m-1 p-1" @click="logout">{{ loginUser.displayName }} logout</b-button>
                <b-img right :src="loginUser.photoURL" width="32" height="32" rounded="circle" alt="no_image"></b-img>
              </div>
              <div v-else class="m-0 p-0">
                <b-button to="/" :variant="commonData.selectedMenuBtnColor" :size="commonData.selectedBtnSize" class="m-1 p-1">login</b-button>
              </div>
            </b-navbar-nav>
            <!-- ログイン end -->
          </b-collapse>
