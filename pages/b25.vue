<template>
  <div class="container-fluid no-gutters">
    <div v-for="dbHeader in dbHeaders" :key="dbHeader.id" class="m-0 p-0">
      <h5 class="text-light text-center m-0 p-1" :style="commonData.buttonColorBasicSet">{{ dbHeader.myData.m25 }}</h5>
    </div>
...
const imagesRef = storageRef.child('bbb/b25')
...
export default {
  ...
  computed: {
    ...
    dbEachPage() {
      return this.$store.getters['bbb/getEachPageById']('b25')
    },
