...
export default {
  ...
  computed: {
    ...
    dbPages() {
      // return this.$store.state.linkDB.dbPages
      // return this.$store.getters['linkDB/orderdDbPages']
      return this.$store.getters['linkDB/orderdMainDate']
    },
    // dbGetMyPageById() {
    //   return this.$store.getters['linkDB/getMyPageById']
    //   // return this.$store.getters['linkDB/getMyPageById'](id)
    //   // }
    // },
    dbHeaders() {
  ...
  created() {
    // 下記の linkDB は store/linkDB.js のファイル名
    this.$store.dispatch('linkDB/init')
  ...
  methods: {
    ...
    add() {
      ...
      // this.$store.dispatch('linkDB/add', { titelName: this.page.titleName, mainText: this.page.mainText })
      this.$store.dispatch('linkDB/add', this.page)
      this.page.titleName = ''
      this.page.linkUrl = ''
      this.page.mainText = ''
      this.page.fileUrl = ''
    ...
    update() {
      // 下記の linkDB は store/linkDB.js のファイル名
      this.$store.dispatch('linkDB/update', { id: this.editId, page: this.page })
    },
    edit(id) {
      this.showEdit = true
      this.showReg = false
      const myPage = this.$store.getters['linkDB/getMyPageById'](id)
    ...
    dataReset() {
      const myPage = this.$store.getters['linkDB/getMyPageById'](this.editId)
      this.page.titleName = myPage.page.titleName
      this.page.linkUrl = myPage.page.linkUrl
      this.page.mainDate = myPage.page.mainDate
      this.page.mainText = myPage.page.mainText
    ...
    remove(id) {
      ...
      // if (myResult) {
      //   this.$store.dispatch('linkDB/remove', id)
      // }
      this.$swal({
        title: '削除してよろしいでしょうか？',
        text: 'この操作は取り消しできません。',
    ...
    // toggle(dbPage) {
    //   this.$store.dispatch('linkDB/toggle', dbPage)
    // },
    onSubmitEdit(evt) {
